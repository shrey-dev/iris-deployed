...
# Function Definition for returning model's prediction
...
flower_sc = joblib.load("iris_scaler.pkl")

# Creating WT Form class
...
def prediction():
    ...
    conetnt['petal_width'] = float(session['pet_wid'])

    results = return_prediction(model=flower_model, scaler=flower_sc, sample_json=content)
